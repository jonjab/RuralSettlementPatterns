...
define([
	...
	"esri/Color"
], function (registry, array, declare, fx, lang, aspect, dom, domAttr, domConstruct, domGeom, domStyle, query, SpatialReference, Graphic, Point, SimpleFillSymbol, SimpleLineSymbol, SimpleMarkerSymbol, Color) {
	return declare(null, {
		...
		addRural: function() {
			var pt = new Point(-119.69, 34.41, new SpatialReference({wkid:102100}))
  			var sms = new SimpleMarkerSymbol().setStyle(
    		SimpleMarkerSymbol.STYLE_SQUARE).setColor(
    		new Color([255,0,0,0.5]));
			var graphic = new Graphic(pt, sms);
			this._main.map.graphics.add(graphic);
		},
